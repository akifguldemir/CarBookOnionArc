...
namespace CarBookWebUI.Controllers.Admin
{
    public class AdminCarController : Controller
    {
        ...
        public async Task<IActionResult> CreateCar(CreateCarDto createCarDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7065/api/Cars", content);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7065/api/Cars/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> UpdateCar(int id)
        {
            ...
            var responseMessage1 = await client.GetAsync("https://localhost:7065/api/Brands");
        ...
        public async Task<IActionResult> UpdateCar(UpdateCarDto updateCarDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7065/api/Cars/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
